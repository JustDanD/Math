...
public class Gauss {
    ...
    private static double[][] methodGausse(double[][] matrix, double[] results) {
    ...
    public static double[] getResultColumn(double[][] jacobi, double[] results) {
    ...
    private static boolean isnNullRow(double[] row) {
